...
export interface Company {
  // Core identifiers (163 valid fields from Supabase)
  company_id: string;
  name?: string | null;
  ...
  // Intelligence & JSON (from joined tables or computed)
  intelligence?: CompanyIntelligence | string | null;
  full_json?: Record<string, any> | null;
  short_json?: Record<string, any> | null;
  innovx?: any; // From innovx_json table
  hiring_rounds?: any[]; // From hiring_rounds_json table
  job_roles?: any[]; // From job_role_details_json table
}

export type CompanyFieldKey = keyof Company;
